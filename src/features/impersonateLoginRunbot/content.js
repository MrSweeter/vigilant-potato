import LimitedShareContentFeature from '../../shared/limitedRunbot/content.js';
import { StorageSync } from '../../utils/browser.js';
import { isAuthorizedLimitedFeature } from '../../utils/authorize.js';
import { fragmentToURLParameters } from '../../utils/url_manager.js';
...
export default class ImpersonateLoginRunbotContentFeature extends LimitedShareContentFeature {
    constructor() {
        super(configuration);
    }

    async load(urlArg) {
        const url = fragmentToURLParameters(urlArg);
